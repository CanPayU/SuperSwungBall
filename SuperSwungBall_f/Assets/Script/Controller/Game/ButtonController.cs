...
namespace GameScene
{
    public class ButtonController : MonoBehaviour
    {
        ...
        Color myColor;
        Collider myCollider;
        //MenuController myMenu; désormais inutile -> voir lignes 43/44
        ...
        void Start()
        {
            ...
            //myMenu = GetComponent<Transform>().parent.gameObject.GetComponent<MenuController>(); désormais inutile -> voir lignes 43 / 44
