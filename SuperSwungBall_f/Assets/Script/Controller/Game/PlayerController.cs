...
namespace GameScene
{
	public class PlayerController : MonoBehaviour
	{
		...
		{ 	get { arrivalPoint = new Vector3(menuController.Get_Coordsdeplacement[0], transform.position.y, menuController.Get_Coordsdeplacement[1]);
				return arrivalPoint; }
		...
		[PunRPC] private void GetMyParam(int viewID, byte[] param){
